window.portfolioData = {
  ...
  projects: [
    ...
    {
      title: "Homelab Windows/Linux avec Active Directory et supervision",
      description:
        "Création d'un environnement de test complet simulant une petite infrastructure d'entreprise : contrôleur de domaine Windows Server, postes clients, serveur Linux, DNS/DHCP, partages réseau, droits utilisateurs, GPO et supervision.",
      technologies: ["Windows Server", "Active Directory", "GPO", "Linux", "DNS/DHCP", "Supervision"],
      github: "",
      demo: ""
    },
    {
      title: "Automatisation d'administration avec PowerShell et Bash",
      description:
        "Création de scripts pour automatiser des tâches courantes : création d'utilisateurs, génération de dossiers partagés, sauvegarde de fichiers, vérification d'espace disque et export de rapports système.",
      technologies: ["PowerShell", "Bash", "Windows", "Linux", "Automatisation", "Rapports"],
      github: "",
      demo: ""
    }
  ],
...
window.portfolioDataEn = {
  ...
  projects: [
    ...
    {
      title: "Windows/Linux homelab with Active Directory and monitoring",
      description:
        "Creation of a complete test environment simulating a small company infrastructure: Windows Server domain controller, client workstations, Linux server, DNS/DHCP services, network shares, user rights, GPOs and monitoring.",
      technologies: ["Windows Server", "Active Directory", "GPO", "Linux", "DNS/DHCP", "Monitoring"],
      github: "",
      demo: ""
    },
    {
      title: "Administration automation with PowerShell and Bash",
      description:
        "Script creation to automate common tasks: user creation, shared folder generation, file backups, disk-space checks and system report exports.",
      technologies: ["PowerShell", "Bash", "Windows", "Linux", "Automation", "Reports"],
      github: "",
      demo: ""
    }
  ],
...
window.portfolioUi = {
  fr: {
    ...
    heroPrimary: "Explorer les catégories",
    heroSecondary: "Mes contacts",
    portalAria: "Catégories du portfolio",
    portalHomeTitle: "Synthèse",
    portalHomeText: "Vue d'ensemble, recherche actuelle, objectif et points clés du profil.",
    portalHomeMeta: "Accueil",
    portalAboutTitle: "À propos",
    portalAboutText: "Synthèse profil, parcours, objectif et informations rapides.",
    ...
    portalMethodTitle: "Méthode",
    portalMethodText: "Soft skills, veille et manière de travailler.",
    portalMethodMeta: "Approche",
    portalCubesTitle: "Cubes CESI",
    portalCubesText: "Études de cas avec problématique, outils, livrables et PDF.",
    portalCubesMeta: "Réalisations",
    portalProjectsTitle: "Projets personnels",
    portalProjectsText: "Pratique technique et traces d'apprentissage.",
    portalProjectsMeta: "Labs",
    portalPathTitle: "Parcours",
    portalPathText: "Diplômes, master en cours et expériences en alternance.",
    portalPathMeta: "Expérience",
  ...
  en: {
    ...
    portalAria: "Portfolio categories",
    portalHomeTitle: "Summary",
    portalHomeText: "Overview, current search, objective and key profile points.",
    portalHomeMeta: "Home",
    portalAboutTitle: "About",
    portalAboutText: "Profile summary, path, objective and quick information.",
    ...
    portalMethodTitle: "Approach",
    portalMethodText: "Soft skills, watch topics and working method.",
    portalMethodMeta: "Method",
    portalCubesTitle: "CESI cases",
    portalCubesText: "Case studies with issue, tools, deliverables and PDFs.",
    portalCubesMeta: "Work",
    portalProjectsTitle: "Personal projects",
    portalProjectsText: "Technical practice and learning traces.",
    portalProjectsMeta: "Labs",
    portalPathTitle: "Background",
    portalPathText: "Degrees, current master's and work-study experience.",
    portalPathMeta: "Experience",
    portalContactTitle: "Contact",
